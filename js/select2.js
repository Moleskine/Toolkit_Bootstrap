...
(function ($, undefined) {
    ...
    AbstractSelect2 = clazz(Object, {
        ...
        init: function (opts) {
            ...
            // EDIT
            search.on("blur", function () { search.removeClass("select2-focused");search.attr("readonly", true);});
        ...
        opening: function() {
			...
			// EDIT
			this.container.parent().parent('.control-group').addClass('active');
    ...
    SingleSelect2 = clazz(AbstractSelect2, {
		...
		createContainer: function () {
            var container = $(document.createElement("div")).attr({
                ...
                "       <input type='text' autocomplete='off' autocorrect='off' autocapitalize='off' spellcheck='false' class='select2-input' readonly/>" ,
                "   </div>" ,
        ...
        initContainer: function () {
            ...
            this.focusser.on("focus", this.bind(function(){
                ...
                if (!this.opened()) {
					...
					// EDIT
					this.container.parent().parent('.control-group').removeClass('active');                    
                }
            }));
